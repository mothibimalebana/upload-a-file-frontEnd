const Upload = () => {
    ...
    return(
        <>
            <div className="container-upload h-full flex justify-center overflow-hidden">
                <div className="upload-form bg-[#fff] flex flex-col  items-center w-[448px] h-[406px] my-[6.5rem] rounded-[0.88rem] border-[2rem] border-[#fff]">
                    ...
                    <div className="form w-[382px] text-start text-[#0A0A0A]">
